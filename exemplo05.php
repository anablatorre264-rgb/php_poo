...
echo "O Funcionário $joao->nome é $tipoFuncionario e o valor do desconto é de R$ $joao->descontos. <br>";
echo "A Funcionária $maria->nome é $tipoFuncionario e o valor do desconto é de R$ $maria->descontos. <br>";
echo "O Funcionário $jose->nome é $tipoFuncionario e o valor do desconto é de R$ $jose->descontos. <br>";
